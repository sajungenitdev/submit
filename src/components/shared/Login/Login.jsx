...
const Login = () => {
    return (
        <div className="min-h-screen flex fle-col items-center justify-center bg-white">
                        ...
                        <form className="space-y-6">
                            ...
                            <div>
                                ...
                                <div className="relative flex items-center">
                                    <input name="username" type="text" required className="w-full text-sm text-slate-900 border border-slate-300 pl-4 pr-10 py-3 rounded-lg outline-blue-600" placeholder="Enter user name" />
                            ...
                            <div className="!mt-12">
                                ...
                                <p className="text-sm !mt-6 text-center text-slate-600">Don't have an account 
                                    <Link href="/register" className="text-blue-600 font-medium hover:underline ml-1 whitespace-nowrap">Register here</Link>
                                </p>
                            </div>
                        </form>
                    </div>
